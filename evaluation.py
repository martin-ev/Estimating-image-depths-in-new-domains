...
"""
evaluation.py: Code to score the results with generated depth ordering
"""
...
def evaluate(approach, model):
    ...
    if approach == "natural2comics":
        ...
        if model == "simple": to_evaluate = "approach21e-06epoch99"
        elif model == "add_text": to_evaluate = "approach2v11e-06epoch99"
        elif model == "add_text_ignoreloss": to_evaluate = "approach2v21e-06epoch99"
        else: raise NotImplementedError
...
if __name__ == "__main__":
    ...
    evaluate(args.approach, args.model)